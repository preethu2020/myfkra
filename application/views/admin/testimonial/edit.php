...
<div class="form-group">
    ...
    <div class="col-md-6"><input type="text" name="name" class="form-control" id="name" value=" <?php echo $testimonial->name;?>"></div>
</div>

<div class="form-group">
    <label for="heading" class="col-md-2 control-label">Testimonial:</label>
    <div class="col-md-6"><input type="text" name="testimonial" class="form-control" id="testimonial" value="<?php echo $testimonial->testimonial;?>"></div>
</div>



<div class="form-group">
     <label class="col-md-2 control-label">Person Image:<?php if($testimonial->image) { ?><a href="<?php echo site_url()."uploads/testimonial/".$testimonial->image;?>"  target="_blank"> [download] <?php } ?></a></label>
    <div class="col-md-3">
    <input type="file" name="image" class="form-control nobb" style="height:auto" id="image" onchange="checkPhoto(this)"><p>Please provide image with 80*80 dimension</p></div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-8"><button type="submit" class="btn btn-primary">Update</button>&nbsp;<button type="button" class="btn btn-default" id="cancel" onclick="javascript:window.location='<?php echo site_url();?>admin/Testimonial'">Cancel</button></div>
</div>
