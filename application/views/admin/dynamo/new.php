...
<div class="form-group">
    ...
    <textarea rows="4" cols="50" name="desc"> </textarea></div>
</div>
...
<div class="form-group">
    ...
    <textarea rows="4" cols="50" name="ardesc"> </textarea></div>
</div>


<div class="form-group">
    <label class="col-md-2 control-label"> Person Image :</label>
    <div class="col-md-3"><input type="file" name="image" class="form-control nobb" style="height:auto" id="image" onchange="checkPhoto(this)"><p> Please use only 480*495 image.</p><</div>
</div>
