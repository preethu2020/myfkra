...
<div class="form-group">
    ...
    <div class="col-md-6"><input type="text" name="branchname" class="form-control" id="branchname" value="<?php echo $branch->Name; ?>"></div>
</div>
<div class="form-group">
    <label for="title" class="col-md-2 control-label">Address:</label>
    <div class="col-md-6"><input type="text" name="address" class="form-control" id="address" value="<?php echo $branch->Address; ?>"></div>
</div>
<div class="form-group">
    <label for="title" class="col-md-2 control-label">Email:</label>
    <div class="col-md-6"><input type="text" name="email" class="form-control" id="email" value="<?php echo $branch->Email; ?>"></div>
</div>
<div class="form-group">
    <label for="title" class="col-md-2 control-label">Fax:</label>
    <div class="col-md-6"><input type="text" name="fax" class="form-control" id="fax" value="<?php echo $branch->Fax; ?>"></div>
</div>
<div class="form-group">
    <label for="title" class="col-md-2 control-label">Latitude:</label>
    <div class="col-md-6"><input type="text" name="latitude" class="form-control" id="latitude" value="<?php echo $branch->Latitude; ?>"></div>
</div>
<div class="form-group">
    <label for="title" class="col-md-2 control-label">Longitude:</label>
    <div class="col-md-6"><input type="text" name="longitude" class="form-control" id="longitude" value="<?php echo $branch->Longitude; ?>"></div>
</div>
<div class="form-group">
    <label for="title" class="col-md-2 control-label">State:</label>
    <div class="col-md-6"><input type="text" name="state" class="form-control" id="state" value="<?php echo $branch->State; ?>"></div>
</div>
