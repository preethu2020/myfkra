...
<div class="form-group">
    ...
    <div class="col-md-6"><textarea type="text" name="desc" class="form-control" id="desc" ></textarea></div>
</div>

<div class="form-group">
    <label for="heading" class="col-md-2 control-label">Arabic Description:</label>
    <div class="col-md-6"><textarea type="text" name="ardesc" class="form-control" id="ardesc" ></textarea></div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-8"><button type="submit" class="btn btn-primary">Add</button>&nbsp;<button type="button" class="btn btn-default" id="cancel" onclick="javascript:window.location='<?php echo site_url();?>admin/Achievers'">Cancel</button></div>
</div>
