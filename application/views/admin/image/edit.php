...
<select class="col-md-3" name="branch">
  <option value="<?php echo $image->branch;?>"><?php echo $image->branch;?></option>
  <option value="Badaa">Badaa</option>
  <option value="Jumeirah"> Jumeirah</option>
</select>
</div>
 
<div class="form-group">
    <label class="col-md-2 control-label">Activity  Image  :<?php if($image->filepath1){?><a href="<?php echo site_url()."uploads/image/".$image->filepath1;?>"  target="_blank"> [download] </a><?php } ?></label>
    <div class="col-md-3"><input type="file" name="actimage" class="form-control nobb" style="height:auto" id="actimage" 
	onchange="checkPhoto(this)"><small>Gallery Image Guidelines <br>
