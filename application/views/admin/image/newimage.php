...
<select class="col-md-3" name="branch">
  ...
  <option value="<?php echo $singleactivity->branch; ?>"><?php echo $singleactivity->branch; ?></option>
...
<div class="form-group">
    ...
    <div class="col-md-3">
	<input type="file" name="actimage" class="form-control nobb" style="height:auto" id="actimage" onchange="checkPhoto(this)"><small>Gallery Image Guidelines <br>
