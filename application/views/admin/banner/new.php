...
<div class="form-group">
    ...
    <div class="col-md-6"><input type="text" name="heading" class="form-control" id="heading" value=""></div>
</div>
...
<div class="form-group">
    ...
    <div class="col-md-6"><input type="text" name="link" class="form-control" id="link" value=""></div>
</div>

<div class="form-group">
    <label class="col-md-2 control-label"> Banner Image :</label>
    <div class="col-md-3"><input type="file" name="bannerimg" class="form-control nobb" style="height:auto" id="bannerimg" onchange="checkPhoto(this)"><p> Please use only 1920*500 image.</p></div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-8"><button type="submit" class="btn btn-primary">Add</button>&nbsp;<button type="button" class="btn btn-default" id="cancel" onclick="javascript:window.location='<?php echo site_url();?>admin/Banner'">Cancel</button></div>
</div>
