...
<div class="form-group">
    <label for="heading" class="col-md-2 control-label">Creativity Person Name:</label>
    <div class="col-md-6"><input type="text" name="name" class="form-control" id="name" value=""></div>
</div>

<div class="form-group">
    <label for="heading" class="col-md-2 control-label">Creativity Description:</label>
    <div class="col-md-6"><input type="text" name="desc" class="form-control" id="desc" value=""></div>
</div>


<div class="form-group">
    <label class="col-md-2 control-label">Creativity  Women Image :</label>
...
<div class="form-group">
    ...
    <div class="col-sm-8"><button type="submit" class="btn btn-primary">Add</button>&nbsp;<button type="button" class="btn btn-default" id="cancel" onclick="javascript:window.location='<?php echo site_url();?>admin/Creativity'">Cancel</button></div>
</div>
