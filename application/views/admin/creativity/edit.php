...
<div class="form-group">
    ...
    <div class="col-md-6"><input type="text" name="name" class="form-control" id="name" value=" <?php echo $creativity->name;?>"></div>
</div>

<div class="form-group">
    <label for="heading" class="col-md-2 control-label">Description:</label>
    <div class="col-md-6"><input type="text" name="desc" class="form-control" id="desc" value="<?php echo $creativity->desc;?>"></div>
</div>



<div class="form-group">
     <label class="col-md-2 control-label">Person Image:<?php if($creativity->image) { ?><a href="<?php echo site_url()."uploads/creativity/".$creativity->image;?>"  target="_blank"> [download] <?php } ?></a></label>
    <div class="col-md-3">
...
<div class="form-group">
    ...
    <div class="col-sm-8"><button type="submit" class="btn btn-primary">Update</button>&nbsp;<button type="button" class="btn btn-default" id="cancel" onclick="javascript:window.location='<?php echo site_url();?>admin/Creativity'">Cancel</button></div>
</div>
