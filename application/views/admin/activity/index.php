...
<table class="table table-bordered table-condensed table-responsive">
  ...
  <tbody>
    ...
    <tr>
	  ...
	  <td><?php  echo $act->title; ?> <br/>
	  <?php  echo $act->artitle; ?> </td>
	  <td><?php  echo substr($act->brief,0,30);?><br/> 
	  <?php  echo substr($act->arbrief,0,30);?> </td>
	  <td><img src="<?php echo site_url();?>uploads/activity/<?php echo $act->bimage; ?>" width="250" height="100" /> </td>
	
	  <td><?php  echo $act->branch; ?> <?php  echo $act->arbranch; ?> </td>
