...
<div class="form-group">
    ...
    <div class="col-md-6">
    <textarea name="ardesc" class="form-control" id="ardesc" ></textarea>
...
<div class="form-group">
    ...
    <div class="col-sm-8"><button type="submit" class="btn btn-primary">Add</button>&nbsp;<button type="button" class="btn btn-default" id="cancel" onclick="javascript:window.location='<?php echo site_url();?>admin/Believers'">Cancel</button></div>
</div>
