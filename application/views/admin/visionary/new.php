...
<div class="form-group">
    ...
    <div class="col-md-6"><textarea type="text" name="postedby" class="form-control" id="postedby" value=""></textarea></div>
</div>
...
<div class="form-group">
    <label class="col-md-2 control-label"> Small Image:</label>
...
<div class="form-group">
    ...
    <div class="col-sm-8"><button type="submit" class="btn btn-primary">Add</button>&nbsp;<button type="button" class="btn btn-default" id="cancel" onclick="javascript:window.location='<?php echo site_url();?>admin/Visionary'">Cancel</button></div>
</div>
