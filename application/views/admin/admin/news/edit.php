...
<div class="form-group">
    ...
    <div class="col-md-6"><input type="text" name="title" class="form-control" id="title" value="<?php echo $news->title;?>"></div>
</div>
<div class="form-group">
    <label for="brief" class="col-md-2 control-label">Brief:</label>
    <div class="col-md-8"><textarea class="form-control" id="brief" name="brief"><?php echo $news->brief;?></textarea></div>
</div>
<div class="form-group">
    <label for="pubdate" class="col-md-2 control-label">Publishing Date:</label>
    <div class="col-md-3"><input type="text" name="pubdate" class="form-control" id="date" value="<?php echo formatdateuser($news->pubdate);?>" readonly></div>
</div>
<div class="form-group">
    <label for="body" class="col-md-2 control-label">Body:</label>
    <div class="col-md-8"><textarea class="form-control" id="body" name="body"><?php echo $news->body;?></textarea></div>
</div>

<div class="form-group">
    <label class="col-md-2 control-label">Image<?php if($news->filepath1){?><a href="<?php echo site_url()."uploads/news/".$news->filepath1;?>"  target="_blank"> [download] </a><?php } ?>:</label>
    <div class="col-md-3"><input type="file" name="filepath1" class="form-control nobb" style="height:auto"></div>
</div>
<div class="form-group">
    <label for="disabled" class="col-md-2">&nbsp;</label>
    <div class="checkbox col-md-6">
    <div class="checkbox nopm">
  	<label><input type="checkbox" id="disabled" name="disabled"  value="1" <?php if($news->disabled==1) echo "checked";?> />Disable news?</label>
	</div></div>
</div>
