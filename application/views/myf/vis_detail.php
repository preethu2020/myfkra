                         ...
                         <div class="col-md-12 col-sm-12">
                            <div class="single-blog blog-details two-column">
                                <div class="post-thumb">
                                    <a href="#"><img src="<?php echo base_url();?>uploads/visionary/<?php echo $viz->mainimage;?>" class="img-responsive" alt=""></a>
                                    <div class="post-overlay">
                                        <span class="uppercase"><!-- <a href="#">14 <br><small>Feb</small></a> --></span>
                                    </div>
                                </div>
                                <div class="post-content overflow">
                                    <h2 class="post-title bold"><a href="#"><?php echo $viz->title;?></a></h2>
                                    <h3 class="post-author"><a href="#">Posted by <?php echo $viz->postedby;?></a></h3>
                                    <p><?php echo nl2br($viz->desc);?></p>
