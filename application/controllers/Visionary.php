...
class Visionary extends CI_Controller {
	...
	public function index()
	{
		...
		$this->data['visionary'] = $this->aaa-> getVisionary();
...
<br/>Request Details<br/>
	...
	<br/>Phone. &nbsp;'.$data1['message']);
		...
		$this->load->view('myf/visionary',$this->data);
	}

	
	function Visionary_Detail($id){
	
		 $this->data['viz'] = $this->aaa->getSingleVisionary($id);
		
		$this->data['testimonials'] = $this->aaa->getAllTestimonials();
		$this->load->view('myf/vis_detail',$this->data);
}
